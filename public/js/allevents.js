...
var cards = "";
    ...
    // const industries = await fetch(base_url + "/api/", {
    //     method: 'GET',
    //     headers: {
...
$(document).ready(function () {
    $("#readMoreButton").click(function () {
        $("#events_data1").removeClass("d-none").toggleClass("d-flex");
        var buttonText = $(this).text();
        if (buttonText === "Explore More") {
            $("#eventsDropdownMenu").addClass('d-sm-none d-lg-block');
        } else {
            $(this).text("Explore More");
            $("#eventsDropdownMenu").removeClass("show");
        }
    });
});
